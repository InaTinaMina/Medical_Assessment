...
if(isset($_POST['submit'])){
   ...
   $select = " SELECT * FROM self_user_details WHERE email = '$email' ";
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = "INSERT INTO `mentalhealth`.`self_user_details` (`F_name`, `M_name`, `L_name`, `email`, `mobile_no`, `city`, `state`, `pincode`, `DOB`, `password`, `register_date`) VALUES ('$fname', '$mname', '$lname', '$email', '$mobileno', '$city', '$state', '$pincode', '$dob', '$pass', current_timestamp());";
